...
#ifndef WL_SB_CLIENT_PROTOCOL_H
#define WL_SB_CLIENT_PROTOCOL_H
 ...
 */
static inline int
wl_sb_add_listener(struct wl_sb *wl_sb,
		   const struct wl_sb_listener *listener, void *data)
{
	return wl_proxy_add_listener((struct wl_proxy *) wl_sb,
				     (void (**)(void)) listener, data);
}

#define WL_SB_CREATE_BUFFER 0
#define WL_SB_CREATE_PLANAR_BUFFER 1
#define WL_SB_CREATE_PLANAR_BUFFER_FD 2
#define WL_SB_CREATE_PLANAR_BUFFER_FD2 3
...
/** @ingroup iface_wl_sb */
static inline void
wl_sb_set_user_data(struct wl_sb *wl_sb, void *user_data)
{
	wl_proxy_set_user_data((struct wl_proxy *) wl_sb, user_data);
}

/** @ingroup iface_wl_sb */
static inline void *
wl_sb_get_user_data(struct wl_sb *wl_sb)
{
	return wl_proxy_get_user_data((struct wl_proxy *) wl_sb);
}

static inline uint32_t
wl_sb_get_version(struct wl_sb *wl_sb)
{
	return wl_proxy_get_version((struct wl_proxy *) wl_sb);
}

/** @ingroup iface_wl_sb */
static inline void
wl_sb_destroy(struct wl_sb *wl_sb)
{
	wl_proxy_destroy((struct wl_proxy *) wl_sb);
}
...
wl_sb_create_buffer(struct wl_sb *wl_sb, uint32_t native_handle, int32_t width, int32_t height, uint32_t stride, uint32_t format)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_sb,
			 WL_SB_CREATE_BUFFER, &wl_buffer_interface, NULL, native_handle, width, height, stride, format);
 ...
 */
static inline struct wl_buffer *
wl_sb_create_planar_buffer(struct wl_sb *wl_sb, uint32_t native_handle, int32_t width, int32_t height, uint32_t format, int32_t offset0, int32_t stride0, int32_t offset1, int32_t stride1, int32_t offset2, int32_t stride2)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_sb,
			 WL_SB_CREATE_PLANAR_BUFFER, &wl_buffer_interface, NULL, native_handle, width, height, format, offset0, stride0, offset1, stride1, offset2, stride2);
 ...
 */
static inline struct wl_buffer *
wl_sb_create_planar_buffer_fd(struct wl_sb *wl_sb, int32_t fd, int32_t width, int32_t height, uint32_t format, int32_t offset0, int32_t stride0, int32_t offset1, int32_t stride1, int32_t offset2, int32_t stride2)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_sb,
			 WL_SB_CREATE_PLANAR_BUFFER_FD, &wl_buffer_interface, NULL, fd, width, height, format, offset0, stride0, offset1, stride1, offset2, stride2);
 ...
 */
static inline struct wl_buffer *
wl_sb_create_planar_buffer_fd2(struct wl_sb *wl_sb, int32_t fd0, int32_t fd1, int32_t fd2, int32_t width, int32_t height, uint32_t format, int32_t offset0, int32_t stride0, int32_t offset1, int32_t stride1, int32_t offset2, int32_t stride2)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_sb,
			 WL_SB_CREATE_PLANAR_BUFFER_FD2, &wl_buffer_interface, NULL, fd0, fd1, fd2, width, height, format, offset0, stride0, offset1, stride1, offset2, stride2);
