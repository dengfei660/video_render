...
//  LED Type Definition
/**
 * LOCALDIMMING UI Strengh INDEX Type Enum.
*/
...
enum v4l2_ext_vbe_pwm_pin_sel_mask {
    V4L2_EXT_VBE_PWM_DEV_PIN_0_MASK =
        1 << V4L2_EXT_VBE_PWM_DEV_PIN0, /**< PWM# 0 */
    V4L2_EXT_VBE_PWM_DEV_PIN_1_MASK =
        1 << V4L2_EXT_VBE_PWM_DEV_PIN1, /**< PWM# 1 */
    V4L2_EXT_VBE_PWM_DEV_PIN_2_MASK =
        1 << V4L2_EXT_VBE_PWM_DEV_PIN2, /**< PWM# 2 */
    V4L2_EXT_VBE_PWM_DEV_PIN_3_MASK =
        1 << V4L2_EXT_VBE_PWM_DEV_PIN3, /**< PWM# 3 */
    V4L2_EXT_VBE_PWM_DEV_PIN_4_MASK =
        1 << V4L2_EXT_VBE_PWM_DEV_PIN4, /**< PWM# 4 */
    ...
    V4L2_EXT_VBE_PWM_DEV_PIN_DEFAULT_MASK /**< depended on pwmIndex setting of
                                             HAL_PWM_SetParam function */
};
...
enum v4l2_ext_hdmi_drm_eotf {
    ...
    V4L2_EXT_HDMI_DRM_EOTF_HDR_LUMINANCE_RANGE, /**< enum value hdr luminance range */
 ...
 *
 * Raw data based on picture header
 *
 * @rst
 * Commands & Parameters
 *   .. code-block:: cpp
...
struct v4l2_ext_decoded_picture_buffer{
    ...
    /** 33 bits target PTS */
    __u64 target_pts;
    /** current VDEC is fronzen or not */
    __u32 bFrozen;
